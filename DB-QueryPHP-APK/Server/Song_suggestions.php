	...
	$arraylistsong = array();
	 class Baihat
	 {
	 	...
	 	$this -> TENCASI = $tencasi;
	     	 ...
	     	 $query ="SELECT DISTINCT * FROM baihat,album,casi WHERE casi.MACASI = album.MACASI AND album.MAALBUM = baihat.MAALBUM GROUP BY casi.MACASI ORDER BY rand(" . date("Ymd") . ") LIMIT 8 ";
